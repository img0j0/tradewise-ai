...
def robot_test():
    """Fresh robot test page - bypasses all caching issues"""
    html = f"""
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>Fresh Robot Test - No Cache</title>
    ...
    <style>
        ...
        /* Fresh Robot Mascot - Exact Same Design */
        .ai-robot-mascot {{
            position: relative;
...
<body>
    ...
    <div class="timestamp">Fresh Load: {time.time()}</div>
    ...
    <div class="checklist">
        ...
        <ul>
            ...
            <li>✓ Two white blinking eyes on the head</li>
            <li>✓ White antenna with blue tip on top</li>
            <li>✓ White mouth bar on the head</li>
            <li>✓ Two waving arms on the sides</li>
            <li>✓ Two supporting legs at bottom</li>
            <li>✓ Gentle floating animation</li>
            <li>✓ Thought bubble saying "Fresh robot design!"</li>
        </ul>
    </div>
    
    <p><strong>This is the exact same robot design that should appear on the main page.</strong></p>
